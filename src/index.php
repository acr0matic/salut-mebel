    ...
    <div class="container">
      <div class="promo">
        <div class="swiper-container promo__slider">
            ...
            <div class="swiper-slide">
              <div class="promo-banner block-skewed">
                ...
                <div class="promo-banner__content">
                  <h1 class="promo-banner__title">Кухни и корпусная мебель <br> от производителя <br> в Москве</h1>
                  <button class="promo-banner__button button button-secondary">
                    <span class="button-secondary__text">Рассчитать стоимость кухни</span>
                  </button>
                </div>
          ...
          <div class="swiper-button-prev promo__slider-left"></div>
          <div class="swiper-button-next promo__slider-right"></div>
        </div>
        <!-- /.swiper-container -->
        <div class="swiper-container promo__offer">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              ...
              <div class="promo__list-item promo-offer">
                ...
                <div class="promo-offer__content">
                  ...
                  <div class="promo-offer__info">
                    ...
                    <div class="promo-offer__discount promo-discount">
                      <div class="promo-discount__count">60</div>
                    </div>
                    <!-- /.promo-item__discount -->
                  </div>
                  <!-- /.promo-item__info -->
    ...
    <div class="container">
      <div class="catalog">
        <div class="catalog__row">
          ...
          <div class="swiper-container catalog__slider catalog__slider--kitchen">
          ...
          <div class="swiper-button-prev catalog__slider-left catalog__slider--kitchen-left"></div>
          <div class="swiper-button-next catalog__slider-right catalog__slider--kitchen-right"></div>
        </div>
        <!-- /.catalog__row -->
        ...
        <div class="catalog__row">
          ...
          <div class="swiper-container catalog__slider catalog__slider--hull">
            <div class="swiper-wrapper catalog__wrapper">
              <div class="swiper-slide">
                <div class="catalog__item catalog-card">
                  <div class="catalog-card__picture">
      ...
      <div class="feedback">
        <div class="feedback__wrapper">
          <div class="feedback__card block-skewed">
            ...
            <div class="link">
              <a href="feedback.php" class="link__item link__item--small svg-wrapper svg-wrapper--hover">
                Читать дальше
